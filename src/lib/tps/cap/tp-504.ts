...
const tp: TP = {
    id: 504,
    duree: '1h00',
    titre: 'Contrôle et Pression des Pneus',
    niveau: 'cap1',
    ...
    activitePratique: [
        { titre: 'Contrôle de la Pression', duree: '20 min', etapes: ['Consulter l\'étiquette de pression dans la portière ou la trappe à carburant.', 'Mesurer la pression de chaque pneu à froid.', 'Ajuster la pression si nécessaire (gonflage ou dégonflage).', 'Contrôler la pression de la roue de secours.']},
        { titre: 'Contrôle de l\'Usure', duree: '25 min', etapes: ['Mesurer la profondeur des sculptures en 3 points de la bande de roulement.', 'Vérifier l\'atteinte du témoin d\'usure légal (1.6 mm).', 'Inspecter les flancs pour détecter toute hernie, coupure ou craquelure.', 'Analyser le type d\'usure (centre, bords, asymétrique).']},
        { titre: 'Rapport et Conseil', duree: '15 min', etapes: ['Noter toutes les valeurs relevées sur la fiche d\'intervention.', 'Informer le client de toute anomalie (usure irrégulière, pneu à remplacer).', 'Expliquer au client l\'importance de maintenir une pression correcte.']}
    ],
    securiteRangement: [
