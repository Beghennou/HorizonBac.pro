...
const tp: TP = { id: 10, duree:'2h00', titre:'BAC PRO Première • Câblage d\'un circuit de moto-ventilateur', situation:'Sur maquette, vous devez câbler un circuit de refroidissement moteur complet, incluant Petite Vitesse (PV) et Grande Vitesse (GV) via des relais et une résistance.', objectif:'Réaliser un montage, valider les déclenchements et effectuer les réglages. (Compétence C2.3)', materiel:['Relais double','Résistance de puissance (PV)','Sonde de température','Fusibles 40A'], 
    etudePrelim:[
