...
const tp: TP = { id: 7, duree:'2h00', titre:'CA 209 • Fermeture centralisée', situation:'La télécommande de la voiture d\'un client ne fonctionne plus, l\'obligeant à utiliser la clé. Vous devez diagnostiquer le système de fermeture centralisée.', objectif:'Tester moteurs/commande, appairer la télécommande et effectuer les réglages. (Compétences C2.1, C2.3)', materiel:['Valise de diagnostic','Multimètre','Télécommande neuve','Pile CR2032'], 
    etudePrelim:[
