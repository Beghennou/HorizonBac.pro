...
const tp: TP = {
    ...
    objectif:'Respecter la procédure constructeur, le calage et remplacer les pièces. (Compétences C2.1, C2.2, C2.4)',
    materiel:['Kit de distribution','Jeu de piges de calage','Clé dynamométrique','Liquide de refroidissement'],
    etudePrelim:[
    ...
    activitePratique:[
        { titre: 'Calage et Préparation', duree: '35 min', etapes: ['Déposer les protections et carters.','Aligner les repères et insérer les piges de calage (vilo/AAC).','Marquer le sens de rotation de l\'ancienne courroie.']},
        { titre: 'Remplacement des Composants', duree: '90 min', etapes: ['Remplacer la pompe à eau, les galets tendeurs et enrouleurs.','Poser la nouvelle courroie en respectant le sens.','Appliquer la tension préconisée à l\'aide de l\'outil spécifique.','Effectuer deux tours moteur manuels et recontrôler le calage.']},
        { titre: 'Finition et Validation', duree: '35 min', etapes: ['Remplir et purger le circuit de refroidissement.','Contrôler l\'absence de fuites et de bruits anormaux.','Documenter l\'intervention avec traçabilité des pièces.']}
    ],
    securiteRangement:['Batterie débranchée','Respect strict des couples de serrage','Propreté des plans de joint'],
    pointsCles:['Calage moteur exact','Tension correcte de la courroie','Purge du circuit de refroidissement'],
