...
const tp: TP = { id: 4, duree:'2h00', titre:'BAC PRO Première • Contrôle du démarreur', situation:'Le diagnostic précédent a mis en cause le démarreur. Vous devez le déposer, le contrôler sur banc et le remplacer pour confirmer la panne et réparer le véhicule.', objectif:'Valider l’état du démarreur, le remplacer eteffectuer un contrôle qualité. (Compétences C2.1, C2.2, C2.4)', materiel:['Banc de test démarreur','Multimètre','Jeu de clés','Pièces de rechange (solénoïde, balais)'], 
    etudePrelim:[
