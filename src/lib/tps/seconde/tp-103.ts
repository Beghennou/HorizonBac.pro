...
const tp: TP = {
    ...
    activitePratique: [
        {
            titre: 'Positionnement précis du véhicule',
            duree: '30 min',
            etapes: [
        ...
        {
            titre: 'Mise en place des bras et préparation du levage',
            duree: '45 min',
            etapes: [
        ...
        {
            titre: 'Levage progressif et sécurisation',
            duree: '30 min',
            etapes: [
        ...
        {
            titre: 'Vérifications finales et descente',
            duree: '15 min',
            etapes: [
