...
const tp: TP = {
    ...
    activitePratique: [
        {
            titre: 'Préparation et Dépose du Tambour',
            duree: '30 min',
            etapes: [
        ...
        {
            titre: 'Nettoyage et Contrôle des Composants',
            duree: '50 min',
            etapes: [
        ...
        {
            titre: 'Remplacement du Kit de Frein (si nécessaire)',
            duree: '45 min',
            etapes: [
        ...
        {
            titre: 'Remontage, Réglage et Validation',
            duree: '25 min',
            etapes: [
