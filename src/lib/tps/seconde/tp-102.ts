...
const tp: TP = {
    ...
    activitePratique: [
        {
            titre: 'Préparation et contrôles préalables',
            duree: '20 min',
            etapes: [
        ...
        {
            titre: 'Opération de levage et calage sécurisé',
            duree: '40 min',
            etapes: [
        ...
        {
            titre: 'Procédure de descente sécurisée',
            duree: '20 min',
            etapes: [
        ...
        {
            titre: 'Finalisation et rangement',
            duree: '10 min',
            etapes: [
